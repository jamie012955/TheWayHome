...
public class LoggingAspect {
	...
	@Before("within(tw.edu.nuk.java2..*) && !execution(* tw.edu.nuk.java2.daoimpl.HBManimalsDao.delete(..))")
	...
	@After("within(tw.edu.nuk.java2..*) && !execution(* tw.edu.nuk.java2.daoimpl.HBManimalsDao.delete(..))")
	public void logAfter(JoinPoint joinPoint) {
		System.out.println("The method " + joinPoint.getSignature().getDeclaringTypeName()+"."+joinPoint.getSignature().getName() + "() ends");
	}
	
	@AfterReturning(pointcut="within(tw.edu.nuk.java2..*) && !execution(* tw.edu.nuk.java2.daoimpl.HBManimalsDao.delete(..))", returning="result")
	...
	@AfterThrowing(pointcut="within(tw.edu.nuk.java2..*) && !execution(* tw.edu.nuk.java2.daoimpl.HBManimalsDao.delete(..))", throwing = "e")
	...
	@Around("execution(* tw.edu.nuk.java2.daoimpl.HBManimalsDao.delete(..)) && target(target) && args(a)")
